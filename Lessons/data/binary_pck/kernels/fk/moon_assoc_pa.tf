KPL/FK
   ...
   Note:  to direct SPICE to associate the lunar "mean Earth" frame 
   ...
   later dates.
      ...
      as the observation time, the output will be:
         ...
         Sub-Earth planetocentric longitude (deg): -6.75531207
         Sub-Earth planetocentric latitude  (deg):  6.77862424
