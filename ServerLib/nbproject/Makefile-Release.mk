...
${OBJECTDIR}/_ext/d4ee5d15/ListenFd.o: /cygdrive/D/JOrbit/Spice/ServerClientLib/src/ListenFd.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d4ee5d15/ListenFd.o /cygdrive/D/JOrbit/Spice/ServerClientLib/src/ListenFd.c

${OBJECTDIR}/_ext/d4ee5d15/ServerProcess.o: /cygdrive/D/JOrbit/Spice/ServerClientLib/src/ServerProcess.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d4ee5d15
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d4ee5d15/ServerProcess.o /cygdrive/D/JOrbit/Spice/ServerClientLib/src/ServerProcess.c

${OBJECTDIR}/_ext/d4ee5d15/SocketFd.o: /cygdrive/D/JOrbit/Spice/ServerClientLib/src/SocketFd.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d4ee5d15
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d4ee5d15/SocketFd.o /cygdrive/D/JOrbit/Spice/ServerClientLib/src/SocketFd.c
