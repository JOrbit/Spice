...
${OBJECTDIR}/src/ServerProcess.o: src/ServerProcess.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ServerProcess.o src/ServerProcess.c

${OBJECTDIR}/src/ServerProcessWorks.o: src/ServerProcessWorks.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ServerProcessWorks.o src/ServerProcessWorks.c
